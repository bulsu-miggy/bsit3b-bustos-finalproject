...
<!--header-->
		...
		<!--about-->
            ...
            <hr class="mt-4">
            <button type="submit" name="verify_btn" class='btn btn-primary btn-block' style="height:40px;width:200px">Verify</button>
			<br>

			<div class="resend-code text-muted">
                    Didn't receive code?
                    <span class="btn-resend text-danger"><a href="verify.php?resend_otp=true">Request again</span></a>
                </div>
			</form>
