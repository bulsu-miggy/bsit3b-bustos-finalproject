...
<html>
<head>
<title>Hotel Dy Grande | login page</title>
...
<body>
	<p style="padding-top: 20px;padding-left: 20px"><a href="../index.php"><i class="fa fa-home" aria-hidden="true" style="font-size: 30px;padding-right: 10px"></i>Home</a></p>
   ...
   <!--/content-inner-->
	...
	<div class="left-content" >
	   <div class="inner-content" >
			...
			<div class="content">
				<h3 style="color: red;font-family: cursive;">Hotel Dy Grande Admin Panel</h3>
